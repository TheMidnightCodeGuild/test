        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <article className="order-2 lg:order-1 mt-8 lg:mt-0">
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">
              Your Trusted Car Rental Partner in india
            </h1>
            <main className="space-y-3 sm:space-y-4 text-gray-600 text-sm sm:text-base">
              <p>
                Welcome to Car Rental Services, your premier destination for hassle-free car rentals in india. With years of experience in the industry, we pride ourselves on providing reliable, comfortable, and affordable transportation solutions.
              </p>
              <p>
