...
const Aboutus = () => {
  const features = [
    {
      ...
      title: "Premium Fleet",
      description: "From compact cars to luxury SUVs, our diverse and well-maintained fleet caters to every need."
    },
    {
    ...
    },
    {
      ...
      title: "24/7 Support",
      description: "Our dedicated team is always available to assist you throughout your rental experience."
    }
  ];
  ...
  return (
    <>
      <Head>
        <title>About Us - Premier Car Rental Service in India | Best Rates & Fleet</title>
        <meta name="description" content="Learn about India's most trusted car rental service. We offer well-maintained vehicles, competitive rates, and 24/7 support for a comfortable and safe journey." />
        <meta name="keywords" content="car rental India, vehicle rental service, luxury car rental, budget car hire, India transportation, trusted car rental" />
        <meta property="og:title" content="About Us - Premier Car Rental Service in India" />
        <meta property="og:description" content="Your trusted car rental partner in India offering well-maintained vehicles, competitive rates and 24/7 support." />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://bestcarrentalindia.com/components/About-us" />
      </Head>
        ...
        >
          ...
          <div className="lg:mt-10 flex items-center justify-center flex-col w-full mt-10 relative z-10 px-4 animate-fadeIn">
            ...
            <p className="text-sm sm:text-base md:text-xl text-white text-center mt-6 max-w-2xl font-light">
              Discover the journey behind Goa's most trusted car rental service
            </p>
            <nav aria-label="breadcrumb" className="bg-gray-200/20 backdrop-blur-md rounded-full px-6 sm:px-8 md:px-10 mt-8 py-3 sm:py-4 border border-white/10">
              <ol className="flex text-center justify-center items-center">
                ...
                <li>
                  <span className="text-yellow-400 font-semibold text-xs sm:text-sm md:text-base" aria-current="page">About Us</span>
                </li>
              </ol>
            </nav>
          </div>
