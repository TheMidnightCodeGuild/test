  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Explore our premium fleet of well-maintained luxury vehicles for rent in india. From Mini Cooper to Audi A4, find the perfect car for your india adventure." />
        <meta name="keywords" content="car rental india, luxury car rental, premium cars, rent a car, india car hire, self drive cars india" />
        <meta property="og:title" content="Premium Car Rental Fleet in india | Best Car Rental india" />
        <meta property="og:description" content="Explore our premium fleet of well-maintained luxury vehicles for rent in india. From Mini Cooper to Audi A4, find the perfect car for your india adventure." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="/images/mini-cooper.png" />
        <link rel="canonical" href="https://www.bestcarrentalindia.com/components/Cars" />
      </Head>
      <main>
        <section className="bg-yellow-50">
          <div className="w-full lg:max-w-[1300px] mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
            <header className="text-center sm:text-left mb-8 sm:mb-10">
              <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">Our Premium Fleet</h1>
              <p className="text-gray-600 max-w-2xl mx-auto sm:mx-0">
                Choose from our selection of well-maintained luxury vehicles perfect for your india adventure
              </p>
            </header>
                    ...
                    <SplideSlide key={index}>
                      <article className="bg-white rounded-xl overflow-hidden border border-yellow-600 h-full flex flex-col mx-auto max-w-sm">
                        ...
                        <div className="p-4 sm:p-6 flex flex-col flex-grow">
                          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{car.name}</h2>
                          <ul className="flex flex-wrap gap-1 sm:gap-2 mb-3 sm:mb-4">
                            {car.features.map((feature, i) => (
                              <li key={i} className="bg-gray-100 text-gray-700 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs sm:text-sm">
                                {feature}
                              </li>
                            ))}
                          </ul>
